        ...
        (function (n) {
          ...
          ((r.TileLayer.Bing = r.TileLayer.extend({
            ...
            initialize: function (t) {
              ...
              if (((t = r.setOptions(this, t)), u.indexOf(t.imagerySet) < 0))
                throw new Error(
                  "'" +
                    t.imagerySet +
              ...
              ((this._imageryProviders = []),
                ...
                r.Browser.android || this.on("tileunload", this._onTileRemove));
            },
            createTile: function (t, e) {
              var n = document.createElement("img");
              return (
                r.DomEvent.on(n, "load", r.bind(this._tileOnLoad, this, e, n)),
                r.DomEvent.on(
                  n,
                  "error",
