!(function (e) {
  ...
  function (e, t, r) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = {
        ...
        kilometers: { factor: 0.001, display: "Kilómetros", decimals: 2 },
        hectares: { factor: 1e-4, display: "Hectáreas", decimals: 2 },
        meters: { factor: 1, display: "Metros", decimals: 0 },
  ...
  function (e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Medir distancias y áreas">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Medir distancias y áreas</h3> <ul class=tasks> <a href=# class="js-start start">Realizar una nueva medición</a> </ul> </div> <div class=js-measuringprompt> <h3>Medir distancias y áreas</h3> <p class=js-starthelp>Añadir puntos al mapa para realizar una nueva medición</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancelar</a></li> <li><a href=# class="js-finish finish">Finalizar medición</a></li> </ul> </div> </div> ';
  },
  function (e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Último punto</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Distancia de la línea</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Superficie</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function (e, t, r) {
    e.exports =
  ...
  function (e, t, r) {
    e.exports =
      '<h3>Superfice</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perímetro</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrar en ésta área</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Eliminar</a></li> </ul> ';
  },
]);
